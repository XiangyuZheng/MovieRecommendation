...
joined = FILTER joined BY ((flights1::Year == 2007 AND flights1::Month >= 6) OR (flights1::Year == 2008 AND flights1::Month <= 5));
joined = FILTER joined BY ((flights2::Year == 2007 AND flights2::Month >= 6) OR (flights2::Year == 2008 AND flights2::Month <= 5));
...
STORE avgTime INTO 's3://hadoop-result-bucket/HW3-pig-join-first1/';